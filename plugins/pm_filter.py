...
async def pm_text(client, message):
    ...
    if not (data and data.get("expiry_time")):
        await message.reply_text(
            ...
            reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton('Buy Premium', callback_data='seeplans')], [InlineKeyboardButton('Join Group To Search', url='https://t.me/MawhOrzzFlick')]]))
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
                ...
                if clicked == typed:
                    await client.send_cached_media(
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            [
                             [
                              InlineKeyboardButton('🍁 Uᴘᴅᴀᴛᴇ', url=f'https://t.me/moviesandwebserieshubOrzz')
                             ]
                            ]
                        )
                    )
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ", url="https://t.me/moviesandwebserieshubOrzz")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
        ...
        buttons = [[
            InlineKeyboardButton('📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ʜᴇʀᴇ', user_id=int(7589671434))
        ],[
        ...
        btn = [[
            InlineKeyboardButton('📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ', user_id=int(7589671434))
        ],[
            InlineKeyboardButton('❌ ᴄʟᴏꜱᴇ ❌', callback_data='close_data')
        ]]
        reply_markup = InlineKeyboardMarkup(btn)
        await query.message.reply_photo(
            photo="https://telegra.ph/file/54e901570419e8c95a645.jpg",
    ...
    # Thanks to @CoderluffyTG for fixing this 
        ...
        await client.edit_message_media(
            query.message.chat.id, 
            query.message.id,
            InputMediaPhoto("https://envs.sh/mTo.jpg")
        )
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="𝑳𝒐𝒅𝒊𝒏𝒈...."
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ɪɴꜰᴏ', callback_data='store_file')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ', url=f'https://t.me/moviesandwebserieshubOrzz'),
            InlineKeyboardButton('Dᴏɴᴀᴛɪᴏɴ', callback_data='source')
        ],[
            InlineKeyboardButton('Rᴇᴘᴏʀᴛ Bᴜɢꜱ & Fᴇᴇᴅʙᴀᴄᴋ',url=f'https://t.me/+xovZm0OqEVIwNDc9')
        ],[ 
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="start"),
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="https://t.me/OrzzQueryBot")
            ]]
            reply_markup = InlineKeyboardMarkup(btn)
            await query.message.edit_text(
