...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            return
        buttons = [[
                    InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url="https://t.me/+xovZm0OqEVIwNDc9"),
                    InlineKeyboardButton('Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ', url="https://t.me/CineWorldOrzz")
                 ],[
                    InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/XHamsterui")
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
            InlineKeyboardButton('Support Group', url="https://t.me/+xovZm0OqEVIwNDc9"),
            InlineKeyboardButton('Owner', url="https://t.me/Xhamsterui")
        ],[
